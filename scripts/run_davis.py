...
if __name__ == '__main__':
    ...
    default_metrics_config = {'METRICS': ['OSPATrack', 'HOTA', 'CLEAR', 'Identity', 'JAndF']}
    ...
    metrics_list = []
    for metric in [trackeval.metrics.OSPATrack, trackeval.metrics.HOTA, trackeval.metrics.CLEAR, trackeval.metrics.Identity, trackeval.metrics.JAndF]:
