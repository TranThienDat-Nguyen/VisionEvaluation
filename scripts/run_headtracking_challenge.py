...
Command Line Arguments: Defaults, # Comments
    ...
    Dataset arguments:
        ...
        'GIOU': True, # Use GIOU distance for evaluation (set to False for IOU distance)
    Metric arguments:
...
if __name__ == '__main__':
    ...
    default_metrics_config = {'METRICS': ['OSPATrack', 'HOTA', 'CLEAR', 'Identity', 'IDEucl'], 'THRESHOLD': 0.4}
    ...
    metrics_list = []
    for metric in [trackeval.metrics.OSPATrack, trackeval.metrics.HOTA, trackeval.metrics.CLEAR, trackeval.metrics.Identity, trackeval.metrics.IDEucl]:
