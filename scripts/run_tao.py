...
Command Line Arguments: Defaults, # Comments
    ...
    Dataset arguments:
        ...
        'GIOU': True, # Flag to compute GIOU metric (compute IOU if set to False)
    Metric arguments:
        'METRICS': ['OSPATrack', 'HOTA', 'CLEAR', 'Identity', 'TrackMAP']
"""
...
if __name__ == '__main__':
    ...
    default_metrics_config = {'METRICS': ['OSPATrack', 'HOTA', 'CLEAR', 'Identity', 'TrackMAP']}
    ...
    metrics_list = []
    for metric in [trackeval.metrics.OSPATrack, trackeval.metrics.TrackMAP, trackeval.metrics.CLEAR, trackeval.metrics.Identity,
